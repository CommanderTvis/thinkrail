// Generated by `bun run icons:generate` from material-icon-theme v5.38.1 — do not edit.
// The SVGs themselves are build output under public/file-icons; only this mapping is committed.

export const FILE_ICON_VERSION = "5.38.1";

export const FILE_ICON_FALLBACK = "file";
