...
scroll of its own, the tree scrolls; rows carry no dividers or accent bar, and only the selected one draws a
rounded, bordered box) and the centre group keeps only its editor. The strip is the same
