...
export const CODEX_MODELS: readonly { id: string; label: string }[] = [
...
export function codexLaunchMenu(
	...
	return [
		...
		[
			...
			{ id: "yolo", label: "Bypass approvals and sandbox (--yolo)", args: "--yolo" },
		],
...
export const CODEX_PERMISSION_MODES: readonly CodexLaunchPreset[] = [
	...
	...codexLaunchMenu(codexEnumValues)
		...
		.filter(
			(preset) =>
				preset.id.startsWith("sandbox-") || preset.id === "full-auto" || preset.id === "yolo",
		),
];
