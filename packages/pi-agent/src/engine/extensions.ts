...
import type { SkillCatalogEntry, SlashCommand } from "@thinkrail/contracts";
...
export function toSkillCommands(skills: readonly Skill[]): SlashCommand[] {
...
const skillListCache = new Map<string, { at: number; value: SlashCommand[] }>();
