 ...
 * reacted to — the document only regenerates once the reader confirms. See SPEC.md.
 */
export function EditableText({
	...
	// its own small button, shown on hover and always reachable by keyboard. See SPEC.md.
	return (
		<div
			data-testid={testId}
			className={cn(
