...
import { defineSpecTool, getIndex, textResult } from "./shared.ts";

const parameters = Type.Object({});

export const specValidate = defineSpecTool<typeof parameters, ValidationReport>({
	name: "spec_validate",
	label: "Spec Validate",
	description:
	...
	parameters,
	async run(_params, cwd) {
		const report = validateGraph(getIndex(cwd).graph());
