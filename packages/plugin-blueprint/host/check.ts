...
export const BLUEPRINT_CHECK_DESCRIPTION = `Read back the interactive specification exactly as the reader's panel renders it: every control, its kind, how many options it has, what is selected, and every place the parser had to decide something for you — a kind word it did not know, an id it invented or renamed, an option with no reason after it. Call this after writing or rewriting ${BLUEPRINT_FILE}. It reads the file and changes nothing.`;
