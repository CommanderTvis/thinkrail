import type { BlueprintDoc, BlueprintEdit, BlueprintSource } from "../contracts";
...
export function existingBlueprintPrompt(): string {
	return `Read ${BLUEPRINT_FILE} in this directory. It is the interactive specification for this project, rendered in a live panel beside this conversation.

You are the AI author for this specification. When decisions change or passages are edited in the panel, you will receive notifications here to re-read the file and reconcile the rest of the document to keep it consistent.

Read the file and tell me in one line that you are ready to drive changes to this blueprint.`;
}
