...
- **Owns:** the eleven shadcn/Radix primitives (`button`, `dialog`, `dropdown-menu`, `context-menu`,
  ...
  `ToolFileLink`; `useThemeSwap`. `./markdown`: `Markdown`, `CodeBlock`, `highlightCode`/
...
- **Public surface (`.`):** `Button`, `ButtonProps`, `buttonVariants`, `CHIP`, `CHIP_DISABLED`,
  ...
  `PopoverAnchor`, `PopoverContent`, `PopoverTrigger`, `SvgAsset`, `ImperativePanelGroupHandle`,
