		...
		<section data-testid="settings-discord" className="flex flex-col gap-16">
			...
			<div className="flex flex-col gap-4">
				...
				<span className="text-text-muted tr-text-metadata">
					Discord always shows the name of the application publishing the presence. ThinkRail's own
					is filled in; replace it with one you registered at{" "}
					<span className="tr-code-text">discord.com/developers/applications</span> to publish under
					your own name and artwork.
				</span>
				<input
