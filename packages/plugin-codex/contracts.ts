...
export const CodexTokenUsageSchema = Type.Object({
	input: Type.Number(),
	output: Type.Number(),
	cacheRead: Type.Number(),
	cacheWrite: Type.Number(),
});
export type CodexTokenUsage = Static<typeof CodexTokenUsageSchema>;

export const CodexPlanItemSchema = Type.Object({
	content: Type.String(),
	status: Type.Union([
...
export type CodexPlanItem = Static<typeof CodexPlanItemSchema>;
...
export const CodexStatusPushSchema = Type.Object({
	...
	usage: Type.Optional(CodexTokenUsageSchema),
	plan: Type.Optional(Type.Array(CodexPlanItemSchema)),
});
...
export const codexContract = definePluginContract({
	...
	methods: {
		...
		models: {
			params: Type.Object({}),
			result: Type.Array(CodexModelSchema),
		},
		configGet: {
	...
	settings: Type.Object({
		...
		/** Starts launcher-created Codex sessions by issuing `/ide on`. */
		ideContext: Type.Optional(Type.Boolean({ default: false })),
