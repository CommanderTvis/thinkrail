...
export interface PluginHostContext<C extends PluginContract> {
	...
	/** Exposes exact absolute paths for core text editing, recomputed per workspace on each read or save. */
	externalFiles(provider: (workspaceId: string) => readonly string[]): void;
